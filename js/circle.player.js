...
var $audio = jQuery('a[href$=".mp3"]');
jQuery('a[href$=".mp3"]').hide();
for (var i=0;i<$audio.length;i++){
	var align = jQuery('a[href$=".mp3"]').eq(i).attr('class');
	console.log(align);
	var template = '<div id="jquery_jplayer_'+i+'" class="cp-jplayer"></div>  <div id="cp_container_'+i+'" class="cp-container '+align+'">  <div class="cp-buffer-holder">  <div class="cp-buffer-1"></div>  <div class="cp-buffer-2"></div>  </div>  <div class="cp-progress-holder">  <div class="cp-progress-1"></div>  <div class="cp-progress-2"></div>  </div>  <div class="cp-circle-control"></div>  <ul class="cp-controls">  <li><a href="#" class="cp-play" tabindex="1">play</a></li>  <li><a href="#" class="cp-pause" style="display:none;" tabindex="1">pause</a></li>  </ul>  </div>';
	jQuery('a[href$=".mp3"]').eq(i).after(template);
	
	var mp3url = jQuery('a[href$=".mp3"]').eq(i).attr('href');
	var NewCirclePlayer = new CirclePlayer("#jquery_jplayer_"+i,
	{
		mp3: mp3url,
	}, {
		cssSelectorAncestor: "#cp_container_"+i,
		supplied: "mp3",
		swfPath: circlePlayerDir+"/js/Jplayer.swf",
		wmode: "window"
	});
